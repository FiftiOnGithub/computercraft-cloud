...
function locate(_nTimeout, _bDebug)
    ...
    if pos1 and pos2 then
        if _bDebug then
            ...
            print("Could be " ..
            pos1.x .. "," .. pos1.y .. "," .. pos1.z .. " or " .. pos2.x .. "," .. pos2.y .. "," .. pos2.z)
        end
        if math.floor(pos1.x) == pos1.x and math.floor(pos1.y) == pos1.y and math.floor(pos1.z) == pos1.z then
            return pos1.x, pos1.y, pos1.z
        end
        if math.floor(pos2.x) == pos2.x and math.floor(pos2.y) == pos2.y and math.floor(pos2.z) == pos2.z then
            return pos2.x, pos2.y, pos2.z
        end
        return nil
    elseif pos1 then
        if _bDebug then
